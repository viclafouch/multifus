...
**Tirage** (`drag`) : l'action de prendre une ligne par sa poignée, et de la porter plus haut ou plus bas pour changer l'ordre du défilement. C'est aussi le geste qui déplace le tableau des runes : la plaque entière se prend, sauf ce qui arrête le clic, et un geste plus court que quatre points ne déplace rien et n'écrit rien.
