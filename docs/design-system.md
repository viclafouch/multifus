...
| `apps/website/src/components/`        | Le cadre d'une page : `SiteShell`, `SiteHeader`, `Cartouche`, `LanguageOffer`, `Band`, `DecorBand`, `WayLink`, `PageCard`, `Opening`, `ProseBlock`, `PlateBlock`, `RivalTable`, `RuneTable` |
