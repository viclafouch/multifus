...
- [ ] Tourner la boucle doublure de l'accueil avec `make-loop`
...
- [ ] Étoffer les quatorze pages, 250 à 370 mots chacune : c'est le seul écart qui reste avec Retro Toolbox
